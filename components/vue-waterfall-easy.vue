<!-- fork from https://github.com/lfyfly/vue-waterfall-easy -->
      ...
      .img-box(
        ...
        component.img-inner-box(
          ...
          component.img-wraper(
            ...
            img(:src="apiRoot  + $_.get(v,srcKey)")
	...
	methods: {
		...
		preload(src, imgIndex) {
			this.imgsArr.forEach((imgItem, imgIndex) => {
				...
				var oImg = new Image();
				oImg.src = this.apiRoot + _.get(imgItem, this.srcKey);
		...
		// ==6== 点击事件绑定
		bindClickEvent() {
			this.$el.querySelector('.vue-waterfall-easy').addEventListener('click', (e) => {
